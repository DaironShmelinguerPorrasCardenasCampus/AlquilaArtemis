...
require_once("../models/entrada_detalle.php");
...
switch ($_GET["op"]){
    ...
    case 'Insert':
        $datos = $detalles->InsertEntrada_Detalle($body["Entrada_Detalle_ID"], $body["Entrada_ID"],$body["Productos_ID"],$body["Obra_ID"],$body["Entrada_Cantidad"],$body["Entrada_Cantidad_Propia"],$body["Entrada_Cantidad_Subaquilada"],$body["Estado"]);
