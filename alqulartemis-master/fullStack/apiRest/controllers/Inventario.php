...
switch ($_GET["op"]){
    ...
    case 'Insert':
        $datos = $inventarios->InsertInventario($body["Inventario_ID"], $body["Productos_ID"],$body["CantidadInicial"],$body["CantidadIngresos"],$body["CantidadSalidas"],$body["CantidadFinal"],$body["FechaInventario"],$body["TipoOperancion"]);
